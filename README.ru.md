...
- **Интеграция с API:** Отправка текста для суммаризации с использованием заданного системного промпта (по умолчанию: "Summarize this in 3 bullet points..."). API запросы настраиваются через параметры.
